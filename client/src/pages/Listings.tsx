    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Input
            ...
            onChange={(e) =>
              setFilters((f) => ({ ...f, minSize: e.target.value }))
            }
          />
          <Input
            type="number"
            ...
            onChange={(e) =>
              setFilters((f) => ({ ...f, maxSize: e.target.value }))
            }
          />
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <Select
          ...
          onValueChange={(v) => setFilters((f) => ({ ...f, ownerType: v }))}
        >
          <SelectTrigger>
        ...
        <Select
          ...
          onValueChange={(v) => setFilters((f) => ({ ...f, titleStatus: v }))}
        >
          <SelectTrigger>
            <SelectValue placeholder="Estado del Título" />
          </SelectTrigger>
          <SelectContent className="z-[9999]">
            <SelectItem value="all">Todos</SelectItem>
      ...
      <div className="space-y-4">
        ...
        <Select
          ...
          onValueChange={(v) =>
            setFilters((f) => ({ ...f, paymentCondition: v }))
          }
        >
          <SelectTrigger>
    ...
    <div className="container mx-auto px-4 py-8 relative">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-muted-foreground">
            {listings?.length || 0} resultados encontrados
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="hidden lg:block space-y-6">
          <div className="bg-card border rounded-xl p-6 shadow-sm sticky top-24 overflow-visible">
            <FilterContent />
          </div>
        </div>
